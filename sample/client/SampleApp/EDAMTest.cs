...
namespace SampleApp
{
    public class EDAMTest {
        public static void Main(string[] args) {
            ...
            TTransport userStoreTransport = new THttpTransport(userStoreUrl, null);
            TProtocol userStoreProtocol = new TBinaryProtocol(userStoreTransport);
            UserStore.Client userStore = new UserStore.Client(userStoreProtocol);

            bool versionOK =
                userStore.checkVersion("Evernote EDAMTest (C#)",
                   Evernote.EDAM.UserStore.UserStoreConstants.EDAM_VERSION_MAJOR,
                   Evernote.EDAM.UserStore.UserStoreConstants.EDAM_VERSION_MINOR).Result;
            ...
            String noteStoreUrl = userStore.getUserUrls(authToken).Result?.NoteStoreUrl;

            TTransport noteStoreTransport = new THttpTransport(new Uri(noteStoreUrl), null);
            TProtocol noteStoreProtocol = new TBinaryProtocol(noteStoreTransport);
            NoteStore.Client noteStore = new NoteStore.Client(noteStoreProtocol);

            // List all of the notebooks in the user's account        
            List<Notebook> notebooks = noteStore.listNotebooks(authToken).Result;
            ...
            byte[] image = SampleApp.Properties.Resources.enlogo; 
            ...
            Note createdNote = noteStore.createNote(authToken, note).Result;
